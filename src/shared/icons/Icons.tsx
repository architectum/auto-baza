...
export const DollarSign = (props: IconProps) => <Icon {...props}><path d="M12 2v20" /><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" /></Icon>;
export const Target = (props: IconProps) => <Icon {...props}><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="5" /><circle cx="12" cy="12" r="1" /></Icon>;
export const Trophy = (props: IconProps) => <Icon {...props}><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6" /><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18" /><path d="M4 22h16" /><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20 7 22" /><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20 17 22" /><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z" /></Icon>;
export const PieChart = (props: IconProps) => <Icon {...props}><path d="M21.21 15.89A10 10 0 1 1 8 2.83" /><path d="M22 12A10 10 0 0 0 12 2v10z" /></Icon>;
export const Zap = (props: IconProps) => <Icon {...props}><path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z" /></Icon>;
export const Layers = (props: IconProps) => <Icon {...props}><path d="m12.83 2.18 8.34 4.63a.67.67 0 0 1 0 1.18L12.83 12.6a1.67 1.67 0 0 1-1.66 0L2.83 7.99a.67.67 0 0 1 0-1.18l8.34-4.63a1.67 1.67 0 0 1 1.66 0z" /><path d="m2 12 9.17 5.08a1.67 1.67 0 0 0 1.66 0L22 12" /><path d="m2 17 9.17 5.08a1.67 1.67 0 0 0 1.66 0L22 17" /></Icon>;

// --- State Icons ---
export const EmptyListIcon = (props: IconProps) => <Icon {...props} strokeWidth="1.5"><rect x="5" y="3" width="14" height="18" rx="2" /><path d="M9 7h6" /><path d="M9 11h4" /><path d="M9 15h2" /><circle cx="16" cy="18" r="4" fill="none" strokeWidth="1.5" /><path d="M14.5 18h3" /></Icon>;
export const ErrorIcon = (props: IconProps) => <Icon {...props} strokeWidth="1.5"><circle cx="12" cy="12" r="9" /><path d="M12 8v4" /><circle cx="12" cy="16" r="0.5" fill="currentColor" stroke="none" /><path d="m15 9-6 6" /><path d="m9 9 6 6" /></Icon>;
export const ReminderIcon = (props: IconProps) => <Icon {...props}><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.73 21a2 2 0 0 1-3.46 0" /><circle cx="18" cy="5" r="3" fill="currentColor" stroke="none" /></Icon>;
export const NotificationIcon = (props: IconProps) => <Icon {...props}><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.73 21a2 2 0 0 1-3.46 0" /></Icon>;
export const OfflineIcon = (props: IconProps) => <Icon {...props}><path d="M2 12.5c3.1-3.1 7.2-4.5 11.1-4.2" /><path d="M6 16.5a7.9 7.9 0 0 1 5-2.5" /><circle cx="12" cy="20" r="1" fill="currentColor" stroke="none" /><path d="M17.3 8.3c1.7.5 3.3 1.4 4.7 2.7" /><path d="M14.8 14c1.2-.1 2.3.2 3.3.8" /><path d="m2 2 20 20" /></Icon>;
export const WifiOff = OfflineIcon;
export const Bell = (props: IconProps) => <Icon {...props}><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.73 21a2 2 0 0 1-3.46 0" /></Icon>;
export const BellRing = (props: IconProps) => <Icon {...props}><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.73 21a2 2 0 0 1-3.46 0" /><path d="M2 8c0-2.2.7-4.3 2-6" /><path d="M22 8a10 10 0 0 0-2-6" /></Icon>;
export const Filter = (props: IconProps) => <Icon {...props}><path d="M22 3H2l8 9.46V19l4 2v-8.54L22 3z" /></Icon>;
...
export const Eye = (props: IconProps) => <Icon {...props}><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z" /><circle cx="12" cy="12" r="3" /></Icon>;
export const EyeOff = (props: IconProps) => <Icon {...props}><path d="M9.88 9.88a3 3 0 1 0 4.24 4.24" /><path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68" /><path d="M6.61 6.61A13.53 13.53 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61" /><line x1="2" x2="22" y1="2" y2="22" /></Icon>;
export const Globe = (props: IconProps) => <Icon {...props}><circle cx="12" cy="12" r="9" /><path d="M3.6 9h16.8" /><path d="M3.6 15h16.8" /><path d="M12 3a14.5 14.5 0 0 0 0 18" /><path d="M12 3a14.5 14.5 0 0 1 0 18" /></Icon>;
