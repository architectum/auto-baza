...
1. [x] **Топ марок за виручкою / кількістю звернень**
...
13. [x] **Сезонність по місяцях за 12 міс** (combo chart: к-сть problems + загальна виручка)
    *Інсайт:* осінь/весна сплеск, січень провал → планування відпусток / акцій.

14. [x] **Сезонність по типах робіт** (зимою більше проблем з …) — наразі без категорії доведеться користуватись `bodyType`, але із додаванням поля `category` (див. нижче) стане дуже цікавим.
...
19. [x] **Кумулятивна виручка з початку року** (line chart)
...
21. [x] **Загальний прибуток (не рейт) по днях тижня**
